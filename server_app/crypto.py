...
from server_app.config import LOG_DIR
...
def get_rsa_key_from_bytes(sock) -> RSAKey:
    length_1 = int.from_bytes(recv_raw_bytes(sock, 4), byteorder="big")
    length_2 = int.from_bytes(recv_raw_bytes(sock, 4), byteorder="big")

    key_part_1 = bytes_to_big_int(recv_raw_bytes(sock, length_1), bytes_order="big")
    key_part_2 = bytes_to_big_int(recv_raw_bytes(sock, length_2), bytes_order="big")
